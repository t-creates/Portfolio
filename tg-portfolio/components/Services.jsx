...
const Services = () => (
  <div className="mt-10 md:mx-24 sm:mx-5 ">
    <div className="p-6 rounded-lg bg-neutral/60 animate-in slide-in-from-bottom-48 duration-1000">
      ...
      <div className="flex flex-col justify-center items-center ">
        <div className="">
          <p className="pt-5  font-bold">Want to grow your through an online presence with an elegant landing page or website?</p>
        </div>
        <div>
          <p className="pt-5  font-bold">Want an online store to take you business to the next level?</p>
        </div>
        <div>
          <p className=" pt-5  font-bold">Need help getting your project live?</p>
        </div>
        <div>
          <p className=" pt-5  font-bold">Hit that <Link href="/contact"><span className="text-green-700/100 font-bold hover:cursor-pointer hover:animate-pulse">CONTACT</span></Link> link.</p>
        </div>
      </div>
    </div>
  </div>
