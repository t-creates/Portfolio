...
const About = () => (
  <div className="sm:p-2 md:p-6 animate-in slide-in-from-bottom-48 duration-1000">
    ...
    <div className="text-xl">
      ...
      <p className="px-5 text-black/75 font-bold test"> I am well organized and focused on growth and development. Problem solving is a skill that I enjoy to cultivate daily.
