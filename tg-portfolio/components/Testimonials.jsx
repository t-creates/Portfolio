    ...
    <div>
      <div className="flex justify-center items-center">
        <h1 className="cursor-pointer py-4 px-2 border-b-4 logoBlue font-semibold
              hover:animate-pulse hover:text-cyan-400 text-cyan-400 navName text-7xl"
        >Testimonials
        </h1>
      </div>
      <div className="carousel carousel-center p-4 space-x-4 bg-neutral rounded-box max-w-md">
