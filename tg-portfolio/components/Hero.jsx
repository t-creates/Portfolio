    ...
    <div className="flex justify-between items-center max-w-5xl lg:m-28  md:px-16 md:m-14 pt-5 rounded-lg ">
      ...
      <div className="flew flex-col">
        <div>
          ...
          <h2 className="font-bold aboutTitle text-5xl text-green-700/95 animate-in fade-in zoom-in delay-300 duration-700">{hero[0].title}</h2>
          <h3 className="font-semibold test text-3xl text-gray-400 animate-in zoom-in delay-700 duration-700">{hero[0].bio}</h3>
        </div>
